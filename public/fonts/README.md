...
Measurement and painting resolve the same native font, glyphs, and advance widths. Native System bold is never emboldened again. Unsupported family/size/weight combinations fail explicitly. Font files retain their native integer pixels; display scaling happens only after the entire canvas is rendered.
